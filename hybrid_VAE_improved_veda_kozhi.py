...
# Supervised Contrastive Loss settings
...
def compute_total_loss(outputs, inputs, combined_emb, batch_labels, kl_weight, epoch):
    """
    Compute balanced total loss with supervised contrastive loss
    """
    losses_dict = {}
...
print("\n" + "="*80)
print("TRAINING WITH HIERARCHICAL + SUPERVISED CONTRASTIVE LOSS")
print("="*80)
print(f"\nImprovements:")
...
print(f"  - Supervised contrastive loss (replaces triplet)")
print(f"  - Temperature: {CONTRASTIVE_TEMPERATURE}, Weight: {CONTRASTIVE_WEIGHT}")
...
for epoch in range(EPOCHS):
    ...
    print(f'Epoch {epoch+1}/{EPOCHS}: '
          ...
          f'KL={epoch_losses["kl"]:.4f}, Contrastive={epoch_losses["contrastive"]:.4f}')
