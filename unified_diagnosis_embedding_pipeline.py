...
print("\n" + "="*80)
print("PHASE 1: LATENT DIMENSION SEARCH (DIAGNOSIS)")
print("="*80)
...
with open('phase1_diagnosis_latent_dim_search.json', 'w') as f:
...
print("\n" + "="*80)
print("PHASE 1: TRAINING SPECIALTY-CONDITIONED AUTOENCODER (DIAGNOSIS)")
print("="*80)
...
print("\n" + "="*80)
print("PHASE 2: GENERATING MULTI-VIEW EMBEDDINGS (DIAGNOSIS)")
print("="*80)
...
print("\n" + "="*80)
print("PHASE 3A: REDUCTION AUTOENCODER - LATENT DIM SEARCH (DIAGNOSIS)")
print("="*80)
...
with open('phase3a_diagnosis_reduction_search.json', 'w') as f:
...
print("\n" + "="*80)
print("PHASE 3A: TRAINING REDUCTION AUTOENCODER (DIAGNOSIS)")
print("="*80)
...
torch.save(reduction_model.state_dict(), 'phase3a_diagnosis_reduction_autoencoder.pth')
...
np.save('phase3a_diagnosis_reduced_embeddings.npy', reduced_embeddings)
print("Saved: phase3a_diagnosis_reduced_embeddings.npy")
print("Saved: phase3a_diagnosis_reduction_autoencoder.pth")
...
print("\n" + "="*80)
print("PHASE 3B: SUPERVISED COMPRESSION NETWORK (DIAGNOSIS)")
print("="*80)
...
torch.save(compression_model.state_dict(), 'phase3b_diagnosis_compression_network.pth')
...
print("\n" + "="*80)
print("GENERATING FINAL EMBEDDINGS FOR ALL PROVIDERS (DIAGNOSIS)")
print("="*80)
...
final_metadata = {
    'pipeline': 'unified_specialty_conditioned_diagnosis',
