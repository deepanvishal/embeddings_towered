...
print("="*80)
print("VARIATIONAL GRAPH AUTOENCODER (VGAE) - GPU VERSION")
print("="*80)
...
print("\nStep 5: Moving graph to GPU and training...")

# Move graph data to GPU
edge_index_gpu = edge_index.to(device)
edge_weight_gpu = edge_weight.to(device)

print("Graph moved to GPU. Starting training (10 epochs)...")
...
for epoch in range(epochs):
    ...
    z = model.encode(edge_index_gpu, edge_weight_gpu)
    
    # Compute losses
    recon_loss = model.recon_loss(z, edge_index_gpu)
