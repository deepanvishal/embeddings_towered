...
# Load 480-dim embeddings from Phase 2
embeddings_480d = np.load('hospital_embeddings_480d.npy')
all_pins = np.load('all_pins.npy', allow_pickle=True).tolist()

with open('pin_to_label.pkl', 'rb') as f:
    pin_to_label = pickle.load(f)

with open('phase2_encoding_metadata.pkl', 'rb') as f:
    phase2_metadata = pickle.load(f)

print(f"Embeddings shape: {embeddings_480d.shape}")
...
# Convert to tensors
embeddings_tensor = torch.FloatTensor(embeddings_480d).to(device)
